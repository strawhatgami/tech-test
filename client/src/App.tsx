...
import Watchtime from "./scopes/Watchtime/Watchtime";
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h5>{`Shingeki no Smartrentin`}</h5>
        <img
          src="https://www.pngkey.com/png/full/536-5367840_attack-on-titan-logo-png-shingeki-no-kyojin.png"
          className="App-logo"
          alt="logo"
        />
      </header>
      <Router>
        <Switch>
          ...
          {token && (
            <>
              <Route path="/watchtime" component={Watchtime}></Route>
            </>
          )}
          <Route path="*" exact>
            <h1>
